...
import moviesReducer, { togglePlayVideo } from "./moviesSlice"; // Importing moviesReducer from moviesSlice.js
...
const appStore = configureStore({
  reducer: {
    ...
    playVideo: togglePlayVideo, // Import and add the playVideo reducer
  },
});
