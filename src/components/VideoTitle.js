...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="  dark:bg-netflix-dark dark:text-neutral-100 w-screen aspect-video pt-[5%] absolute text-black bg-gradient-to-r from-black-500 pl-2">
      <h1 className="  dark:text-neutral-800 text-xl md:text-4xl ml-6 px-1  font-bold">{title}</h1>
      ...
      <div className="flex ml-6 mt-6 ">
        <button
          className="bg-white py-1  dark:bg-netflix-dark dark:text-neutral-100 text-sm md:py-4 md:px-16 px-2 mr-4 ml-2 md:ml-6
