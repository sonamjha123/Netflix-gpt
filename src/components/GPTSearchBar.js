...
const GPTSearchBar = () => {
  ...
  return (
    <div className="pt-[45%] md:pt-[25%] flex justify-center">
      <form
        className="bg-black  dark:text-neutral-800  text-neutral-500 bg-opacity-70 w-full md:w-1/2 grid grid-cols-12"
      ...
      >
        <input
          ...
          className=" dark:text-neutral-800  text-neutral-500 text-xs md:text-base p-2 m-2 col-span-8 border-2 border-gray-300 rounded-lg"
        />
        <button
          className=" dark:text-neutral-100 dark:bg-netflix-dark text-xs md:text-base col-span-3 p-2 m-3 bg-red-500 hover:bg-red-800 text-white rounded-lg"
